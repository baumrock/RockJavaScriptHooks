...
(() => {
  ...
  class ProcessWireHooks {
    ...
    static addHookAfter(name, fn, priority = 100) {
    ...
    static addHookBefore(name, fn, priority = 100) {
    ...
    static wire = function (object, name = null) {
      ...
      for (let key in props) {
        ...
        props[newKey] = {
          value: function (...args) {
            ...
            hookEvent.return = originalMethod.apply(
              this,
              hookEvent.arguments()
            );
  ...
  ProcessWire.addHookAfter = ProcessWireHooks.addHookAfter;
  ProcessWire.addHookBefore = ProcessWireHooks.addHookBefore;
  ProcessWire.wire = ProcessWireHooks.wire;
})();
